...
export const generateEmergencyTicketSummary = async (input: SummaryInput): Promise<SummaryResult> => {
  ...
  return {
    summary: `[Mock AI Summary] Reported ${input.incidentType} at ${input.gpsCoordinates}. AI Confidence: ${Math.round(input.aiConfidenceScore * 100)}%. Source: Social Media stream.`,
